...
import logo from "../../../img/icon16.png";
const M1 = {
    hidden: {
        transform: "scale(0.8)",
        opacity: 0,
...
export default function PortfolioAnalytics01() {
    return (
        <Parallax
            renderLayer={(percentage) => (
                ...
                >
                    <div className="sc-1lw4m5x-1 sc-1hu6ba9-1 iukxsw eYZLRR">
                        ...
                        >
                            <h1>
                                Powerful portfolio reporting at the tap of a
                                finger
                            </h1>
                        </motion.div>
                        <motion.div
                        ...
                        >
                            <p>
                                Portfolio Analytics is a free portfolio analysis
                                tool, featuring in-depth investment statistics
