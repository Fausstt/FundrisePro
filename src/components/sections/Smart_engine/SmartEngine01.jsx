...
import logo from "../../../img/icon09.png";
const M1 = {
    hidden: {
        transform: "scale(0.8)",
        opacity: 0,
...
export default function SmartEngine01() {
    return (
        <Parallax
            renderLayer={(percentage) => (
                ...
                >
                    <div className="sc-1lw4m5x-1 sc-1hu6ba9-1 iukxsw eYZLRR">
                        ...
                        >
                            <h1>
                                Get the best price and liquidity from multiple
                                exchanges
                            </h1>
                        </motion.div>
                        <motion.div
                        ...
                        >
                            <p>
                                ...
                                guesswork out of investing. By connecting to
                                Binance, HitBTC, LMAX, Kraken and Bitfinex
                                exchanges, we can get you the best liquidity and
